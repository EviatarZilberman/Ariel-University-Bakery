...
namespace Bakery.Employee
{
    class Cashier : BakeryEmployee
    {
                                                                         ...
                                                                         // the bakery by name and amount.
                {
                    if (!(client.List[i].GetType() == typeof(Drink)))
                    {
                                                                                                               ...
                                                                                                               // client list.
                        {
                            ...
                            this.MoneyEarned += client.List[i].DemandOfProducts * bakery.ProductsInBakery[j].Price;
                    ...
                    Console.WriteLine("Your total purchase sum is " + totalSum);
                    Console.WriteLine();
                }
            }
        ...
        public void buyProductsThread(Client client, TheBakery bakery) // The method checks the client's shopping list and the cashier sells them.
                                                                       // If there are not enough products the cashier call the baker to make more.
        {
