...
namespace Bakery.BakeryLogic
{
    class TheBakery
    {
        private static Product[] productsInBakery;
        private static BakeryEmployee[] employees;
        ...
        public void isHappy(Client client) // Check if the client has gotten all he wanted.
        {
            ...
            Console.WriteLine($"{client.FirstName} {client.LastName} purchase summary is: {client.PurchaseSummary}");
            Console.WriteLine();
        }
        ...
        {
            Console.WriteLine($"Thank you for buying in Ariel University bakery! here's the money we have earned today: {MoneyEarned}\n");
            Document doc = new Document();
            Section section = doc.AddSection();
            Paragraph para = section.AddParagraph();
            string moneyEarned = MoneyEarned.ToString();
