...
namespace Bakery.Products
{
    class Bread :Product
    {
        ...
        public Bread(string name, double price, int calories, bool hasMilk, Time_date expieryDate, int amountInBakery, bool sliced, bool forShabath, bool blacBread) : base(name, price, calories, hasMilk, expieryDate, amountInBakery)
        {
            this.sliced = sliced;
